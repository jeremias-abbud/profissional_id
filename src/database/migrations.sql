...
create policy "Allow carousel image uploads" on carousel_images
  for insert with check (true);

-- Política para permitir atualização de imagens
create policy "Allow carousel image updates" on carousel_images
  for update using (true);

-- Política para permitir exclusão de imagens
create policy "Allow carousel image deletes" on carousel_images
